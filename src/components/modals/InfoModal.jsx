...
import partner4 from "../../assets/partners/BILC.jpg"
import partner5 from "../../assets/partners/eprc.jpg"
import partner1 from "../../assets/partners/EUforGeorgia.jpg"
import partner3 from "../../assets/partners/IJH.jpg"
import partner2 from "../../assets/partners/KAS.jpg"
import partner6 from "../../assets/partners/SSFund.jpeg"
...
const InfoModal = () => {
    ...
    return (
        <>
            <div onClick={() => setIsOpen(true)} className='w-20 hover:-translate-y-2 transition-all delay-300 cursor-pointer aspect-square rounded-full bg-white absolute right-10 bottom-10'>
                ...
                <div className='w-dvw absolute flex items-center justify-center left-0 top-0 h-dvh'>
                    ...
                    <div className='z-51 w-3/4 h-3/4 bg-white rounded-4xl flex flex-col'>
                        <div className='w-full bg-indigo-600 rounded-t-4xl border-white border-b-2 py-7 px-5 flex justify-between items-center'>
                            <span className='text-2xl text-white font-bold'>საჭირო ინფორმაცია</span>
                            <X className='hover:text-red-400 text-white cursor-pointer' onClick={() => setIsOpen(false)} />
                        </div>
